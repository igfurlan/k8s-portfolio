...
- Grafana/Loki showing audit log entries (e.g., a `kubectl exec` or Secret access event)
- `etcdctl get /registry/secrets/...` output showing the `k8s:enc:aescbc:v1:` prefix (confirming encryption)
