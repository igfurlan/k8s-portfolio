...
hero:
  ...
  image:
    ...
    alt: Terminal showing kubectl output alongside the Kubernetes logo
  actions:
...
<CardGrid stagger>
  ...
  <Card title="💾 Backup & Recovery" icon="open-book">
    ...
    [Read the Backup Strategy →](/k8s-portfolio/backup/strategy/)
  </Card>
</CardGrid>
