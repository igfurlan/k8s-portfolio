...
![GitHub Actions CI pipeline — validate job confirming the app repo → CI → gitops repo flow](/k8s-portfolio/images/ci-pipeline-validate.png)
...
![ArgoCD showing the backstage application in Synced/Healthy state with full resource tree](/k8s-portfolio/images/argocd-backstage-application.png)
...
![GitHub Actions CI run after merge to main — all steps passing: build, push to GHCR, gitops update](/k8s-portfolio/images/ci-pipeline-merged-pr.png)
...
![Argo Rollouts dashboard showing canary deployment progress with traffic weight stages](/k8s-portfolio/images/argo-rollout.png)

![Argo Rollouts UI showing active AnalysisRun with Prometheus metric evaluation during canary](/k8s-portfolio/images/argo-rollout-ui-analysis.png)
...
![SealedSecret resource — backstage-db sealed secret as seen in the cluster](/k8s-portfolio/images/sealed-secrets.png)
