...
import NetworkDiagram from '../../../components/diagrams/NetworkDiagram.astro';
...
|---|---|---|
| `harbor-tls` | harbor | Ready *(at time of capture; Harbor since retired)* |
...
| `harbor` | harbor-core, registry, trivy, jobservice, portal | Private container registry + vulnerability scanning — **since retired**, see [Cluster Security](/k8s-portfolio/security/overview/#harbor--private-container-registry) |
