...
import ObservabilityStack from '../../../components/diagrams/ObservabilityStack.astro';
import RolloutAnalysis from '../../../components/diagrams/RolloutAnalysis.astro';
import LogsFlow from '../../../components/diagrams/LogsFlow.astro';
...
![Prometheus targets page showing all scrape targets as UP](/k8s-portfolio/images/prometheus-targets.png)
...
![Grafana Explore — Loki log stream showing Kubernetes HTTP errors by namespace](/k8s-portfolio/images/loki-kubernetes-http-errors.png)

![Grafana Explore — Loki log stream showing systemd journal errors from host services](/k8s-portfolio/images/loki-journald-errors.png)
...
![Custom Grafana "Homelab Backup & Storage" dashboard showing backup status across all layers](/k8s-portfolio/images/grafana-backup-dashboard.png)
...
![Grafana Kubernetes cluster resource usage dashboard — CPU, memory, and workload metrics](/k8s-portfolio/images/grafana-kubernetes-resources-dashboard.png)
...
![AlertManager notification via Telegram bot — critical alert example](/k8s-portfolio/images/alerts-telegram.png)

![Prometheus alerts page showing active alert rules and their states](/k8s-portfolio/images/prometheus-alerts.png)
