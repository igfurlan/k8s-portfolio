...
{/* IMAGE: Custom Grafana "Homelab Backup & Storage" dashboard showing all panels */}
...
- Custom "Homelab Backup & Storage" Grafana dashboard (full screenshot showing all stat panels green)
- Grafana stat panels showing backup status OK for all jobs
- OCI Object Storage bucket page showing prefix breakdown and total usage
- `velero backup get` output showing recent successful backups
- AlertManager showing a fired BackupFailed or BackupStale alert (for illustration)
